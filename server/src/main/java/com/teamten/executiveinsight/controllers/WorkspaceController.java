...
public class WorkspaceController {
    ...
    public ResponseEntity<?> createWorkspace(@RequestBody WorkspaceRequest workspaceRequest) {
        try {
            ...
            publisher.publishEvent(new SendNotificationEvent(workspaceRequest.email(), "Your very own workspace " + workspaceRequest.name() + " has been created"));
    ...
    public ResponseEntity<?> joinWorkspace(@PathVariable String code, @PathVariable String email) {
        ...
        return ResponseEntity.status(HttpStatus.NOT_FOUND).body("You have already joined the workspace");
    }
    ...
    public ResponseEntity<String> sendInvite(@PathVariable String code, @PathVariable String email) {
        ...
        publisher.publishEvent(new SendNotificationEvent(email, code));
