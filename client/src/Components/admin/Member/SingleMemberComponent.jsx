    ...
    <div>
      <div className='d-flex justify-content-between'>
          <button className="btn btn-light form-control d-flex justify-content-start align-items-center" style={{ borderTopRightRadius: "0", borderBottomRightRadius: "0" }} onClick={viewProfile}>
            ...
            {userJoinWorkspace.user.image!==null && <Image src={`data:image/png;base64,${userJoinWorkspace.user.image}`} alt="Profile" roundedCircle style={{ width: '40px', height: '40px' }} className='mx-2' />}
