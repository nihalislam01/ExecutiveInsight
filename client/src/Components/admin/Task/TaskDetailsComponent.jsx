                    ...
                    {props.task.assigned && props.task.user!==null &&
                        ...
                        <div className="btn btn-light form-control d-flex align-items-center border-0 shadow" onClick={goToProfile}>
                            <div className="d-flex" style={{width: "200px"}}>
                                ...
                                {props.task.user.image!==null && <Image src={`data:image/png;base64,${props.task.user.image}`} alt="Profile" roundedCircle style={{ width: '30px', height: '30px' }} className='mx-2' />}
