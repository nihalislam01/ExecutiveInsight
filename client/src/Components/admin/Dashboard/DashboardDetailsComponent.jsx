...
import { faBangladeshiTakaSign, faBox, faCartShopping, faChartLine, faUserGroup } from "@fortawesome/free-solid-svg-icons";
    ...
    useEffect(()=>{
        ...
        const getDetails = async () => {
            ...
            await retrieveDistinctDashboardDetailsApi(id)
                .then((response)=>setDistinct(response.data))
                .catch((error)=>{
                ...
                <div className="text-start dashboard-box">
                    <div className="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <h4 className="mx-4">{formatNumber(details.users)}</h4>
                        </div>
                    </div>
                </div>
                <div className="text-start dashboard-box">
                    <div className="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            {details.quantity===0 && <h4 className="mx-4">TK<FontAwesomeIcon icon={faBangladeshiTakaSign} /> {formatNumber(details.totalValue)}</h4>}
                            {details.quantity!==0 && <h4 className="mx-4">TK<FontAwesomeIcon icon={faBangladeshiTakaSign} /> {formatNumber(details.totalValue/details.quantity)}</h4>}
                        </div>
                    </div>
                </div>
                <div className="text-start dashboard-box">
                    <div className="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <h4 className="mx-4">TK<FontAwesomeIcon icon={faBangladeshiTakaSign} /> {formatNumber(details.totalValue)}</h4>
                        </div>
                    </div>
                </div>
                <div className="text-start dashboard-box">
                    <div className="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <h4 className="mx-4">{formatNumber(details.quantity)}</h4>
                        </div>
                    </div>
                </div>
            </div>
